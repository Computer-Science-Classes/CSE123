...
public class Client {
    ...
    public static void main(String[] args) {
        Collections.addAll(ops, "create", "head", "history", "commit", "drop", "synchronize",
                "quit");
        ...
        while (!op.equalsIgnoreCase("quit")) {
            ...
            while (!ops.contains(op) || (!op.equalsIgnoreCase("create")
                    && !op.equalsIgnoreCase("quit") && !repos.containsKey(name))) {
            ...
            if (op.equalsIgnoreCase("create")) {
                ...
                System.out.print(
                        "Which repository would you like to " + "synchronize into the given one? ");
