...
public class Client {
    public static final Cipher CHOSEN_CIPHER = new MultiCipher(
            List.of(new CaesarShift(4), new CaesarKey("123"), new CaesarShift(1)));
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        do {
            ...
            if (chosen == 1 || chosen == 2) {
                ...
                System.out.println(
                        chosen == 1 ? CHOSEN_CIPHER.encrypt(input) : CHOSEN_CIPHER.decrypt(input));
