...
/**
 * The Allocation class represents an unmodifiable relief solution. It provides
 * methods to retrieve the total cost and total helped population of the
 * solution. The ordering of the regions in the solution determines the
 * population that can be helped.
 */
public class Allocation {
    ...
    /**
     * Returns a new Allocation with the contents of this allocation and the passed
     * in region added to it.
     *
     * @param region
     *            to be added to the end of the new Allocation.
     * @return a new Allocation with region added to it.
     * @throws IllegalArgumentException
     *             if this Allocation does contain the region.
     */
    ...
    /**
     * Returns a new Allocation with the contents of this allocation and the passed
     * in region removed from it.
     *
     * @param region
     *            to be removed from the new Allocation.
     * @return a new Allocation with region removed from it.
     * @throws IllegalArgumentException
     *             if this Allocation doesn't contain the region.
     */
    ...
    /**
     * Calculates and returns the total population that can be helped by this
     * Allocation.
     *
    ...
    /**
     * Compares the specified object with this allocation for equality. Returns true
     * if the specified object is also an Allocation and the two Allocations have
     * the same collection of regions.
     *
     * @param other
     *            object to be compared for equality with this allocation
